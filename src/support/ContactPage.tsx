...
export function ContactPage() {
  return (
    <SupportPageFrame description="告诉我们你的品牌、产品、目标市场和当前困惑，我们会先判断问题属于诊断、建设还是定制范围。" eyebrow="联系 AskLume" heroAlt="深蓝环境中的证据光束与结构化材料" heroImage={aboutHero} page="contact" primaryAction={{ href: 'mailto:hello@asklume.com?subject=咨询AskLume服务', label: '发送邮件咨询' }} secondaryAction={{ href: './diagnostic.html', label: '了解诊断流程' }} title="把问题交给专家团队" >
      ...
      <section className={`${styles.section} ${styles.sectionSoft}`}><div className={styles.inner}><div className={styles.sectionHeading}><p className={styles.eyebrow}>媒体与合作</p><h2>需要采访、研究合作或公开案例？</h2><p>请在邮件主题中注明“媒体联系”“研究合作”或“案例授权”，并附上背景说明。</p><a className={styles.inlineLink} href="mailto:hello@asklume.com?subject=媒体或研究合作">联系媒体与研究合作 →</a></div></div></section>
    </SupportPageFrame>
  )
}
