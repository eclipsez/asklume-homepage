...
import styles from './BenefitsSectionV2.module.css'

export function BenefitsSectionV2() {
  return (
    <section id="v2-features" className={styles.section}>
