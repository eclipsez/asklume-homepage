...
import styles from './CapabilitiesSectionV2.module.css'

export function CapabilitiesSectionV2() {
  return (
    <section id="v2-capabilities" className={styles.section}>
        ...
        <div className={styles.grid}>
          <div className={styles.card}>
            <div className={styles.iconPod}>
              <IconV2 name="search" size={26} />
            </div>
            <h4 className={styles.cardTitle}>AI搜索与洞察</h4>
            <p className={styles.cardDesc}>追踪品牌在主流AI平台中的表现、发现问题、洞察机会。</p>
          </div>

          <div className={styles.card}>
            <div className={styles.iconPod}>
              <IconV2 name="shield" size={26} />
            </div>
            <h4 className={styles.cardTitle}>持续监测与预警</h4>
            <p className={styles.cardDesc}>实时监测AI回答变化、识别风险信号、助力品牌管理。</p>
          </div>

          <div className={styles.card}>
            <div className={styles.iconPod}>
              <IconV2 name="cube" size={26} />
            </div>
            <h4 className={styles.cardTitle}>企业协同与资产管理</h4>
            <p className={styles.cardDesc}>跨团队、跨系统协作，沉淀企业资产、提升组织生产力。</p>
          </div>

          <div className={styles.card}>
            <div className={styles.iconPod}>
              <IconV2 name="spark" size={26} />
            </div>
            <h4 className={styles.cardTitle}>定制化智能方案</h4>
