...
const diagnosisEmailHref = `mailto:${siteContact.email}?subject=${encodeURIComponent('申请AI认知基线诊断')}`
      ...
      <div className={styles.banner}>
        <div>
          ...
          <div className={styles.actions}>
            <a href={diagnosisEmailHref} className={styles.primaryPill}>
              申请基线诊断 <SiteIcon name="arrow" size={14} />
            </a>
