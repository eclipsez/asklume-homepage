...
export const pageSchemas: Record<string, unknown> = {
  ...
  'partners.html': { '@context': 'https://schema.org', '@graph': [organization, website, page('渠道与代理合作', '/partners.html'), service('渠道与代理合作', '/partners.html', '面向品牌、公关、SEO、内容营销、出海与行业服务伙伴的 GEO 项目合作。')] },
  'media.html': { '@context': 'https://schema.org', '@graph': [organization, website, page('媒体与研究合作', '/media.html')] },
  'public-sector.html': { '@context': 'https://schema.org', '@graph': [organization, website, page('政府与产业合作', '/public-sector.html'), service('政府与产业合作', '/public-sector.html', '面向区域、园区和产业主体的公开信息、数字证据与 AI 可发现性建设。')] },
